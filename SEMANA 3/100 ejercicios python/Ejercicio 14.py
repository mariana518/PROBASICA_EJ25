...
#La función sample() del módulo random de Python permite realizar un muestreo aleatorio, que selecciona muchos elementos al azar de una lista sin repetir ninguno de ellos
